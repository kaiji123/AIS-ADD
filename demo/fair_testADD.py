...
if __name__ == "__main__":
    ...
    x_dir = os.path.join('datasets\\far_near_test\\images')
    y_dir = os.path.join('datasets\\far_near_test\\annotations')
    ...
    for i,z in zip(images,annotations):
        ...
        if s == 1:
            ...
            mean_time = mean_time + elapsed_time
    ...
    print("iou is", iou_mean/10)
    print("fscore is", fscore / 10)
    mean_time = mean_time /10
    print(f"Mean inference is {mean_time:.10f} seconds")
